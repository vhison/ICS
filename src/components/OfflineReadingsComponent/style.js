...
export const styles = StyleSheet.create({    
    ...
    verticalListComponentTitleOne : {color:"white",fontWeight:"bold",color:"#000",fontSize:11,marginTop:3, textAlign : "left"},
    verticalListTitleOne : {color:"white",fontWeight:"bold",color:"#000",fontSize:10,marginTop:3, textAlign : "left"},
